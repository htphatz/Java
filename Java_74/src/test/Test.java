...
public class Test {
    public static void main(String[] args) throws IOException, FileNotFoundException, ClassNotFoundException {
        ...
        do { 
            ...
            System.out.println("10. Viết đối tượng sinh viên trong danh sách vào file");
            System.out.println("11. Đọc file lấy đối tượng và thêm đối tượng vào danh sách");
            ...
            switch (luaChon) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    System.out.print("Nhập vào tên file ghi: ");
                    String tenFileGhi = scanner.nextLine();
                    danhSachSinhVien.ghiDuLieuVaoFile(tenFileGhi);
                    break;
                case 11:
                    System.out.print("Nhập vào tên file đọc: ");
                    String tenFileDoc = scanner.nextLine();
                    danhSachSinhVien.docFileLayDoiTuongVaThemVaoDanhSach(tenFileDoc);
                    break;
                default:
                    break;
            }
        ...
        // C:\\Users\\HP\\Documents\\Workspace\\Java_Backend\\Java core\\Java_74
    }
}
